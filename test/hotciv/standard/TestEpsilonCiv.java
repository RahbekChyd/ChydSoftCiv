...
public class TestEpsilonCiv {
	...
	@Before
	public void setUp() {
		game = new GameImpl(new EpsilonWinnerStrategy(), new AlphaAgeStrategy(), new AlphaActionStrategy(), new DeltaMapStrategy(), new EpsilonAttackingStrategy(new RollAValue(5)));
		attStrat = new EpsilonAttackingStrategy(new RollAValue(3));
	}
	...
	public void blueWinsWhenblueWon3Battles() {
	 ...
	 @Test
	    ...
	    public void attackerWinFightDefenderDie() {
	        ...
	        assertThat("Red attacker has moved", game.getUnitAt(new Position(2, 0)), is(nullValue()));
